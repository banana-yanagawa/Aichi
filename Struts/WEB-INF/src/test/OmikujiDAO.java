...
public class OmikujiDAO {
	 ...
	 * @throws SQLException
	 */
	public OmikujiBean searchOmikuji(Date formatDate) throws SQLException{
	 ...
	 * @throws SQLException
	 */
	public OmikujiBean choiceOmikuji(int omikujiId) throws SQLException{
